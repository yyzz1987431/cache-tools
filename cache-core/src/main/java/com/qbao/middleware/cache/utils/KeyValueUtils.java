...
public class KeyValueUtils implements IKeyValueClient {
     ...
     * java.lang.Object)
     */
    public <T extends Serializable> void set(String key, T data) throws CacheCodeException {
     ...
     * java.lang.Class)
     */
    public <T extends Serializable> T get(String key, Class<T> clazz) throws CacheCodeException {
